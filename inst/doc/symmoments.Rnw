...
\subsection*{Create an \code{mpoly} object}
...
print(t0)
@
\subsection*{Convert an \code{mpoly} object to a moment object}
<<<noncentral4, echo=TRUE, term=TRUE, results=verbatim>>=
t1 <<- convert.mpoly(t0)      
t1
@
\subsection*{Convert a \code{moment} object to a \code{multipol} object}
<<noncentral5, echo=TRUE, term=TRUE, results=verbatim>>=
t2 <<- convert.multipol(t1)      
t2
@
\subsection*{Convert from \code{multipol} back to \code{mpoly} through \code{moment}}
